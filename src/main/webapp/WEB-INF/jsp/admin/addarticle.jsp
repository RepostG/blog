...
<div class="page-container">
	<form action="addarticles.html" method="post" enctype="multipart/form-data" class="form form-horizontal" id="banneradd">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			<script id="introduction" name="contents" style="width:100%;height:500px;" type="text/plain"></script>
			</div>
		</div>

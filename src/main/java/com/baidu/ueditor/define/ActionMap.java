...
public final class ActionMap {
	...
	public static final int LIST_IMAGE_CUSTOMER = 8;
	
	public static final int DELETE_IMAGE_CUSTOMER = 9;
	/**
	 * 多文件上传
	 */
	public static final int UPLOAD_MULTI_IMAGE = 10;
	...
	static {
		mapping = new HashMap<String, Integer>(){{
			...
			put( "deleteimage", ActionMap.DELETE_IMAGE_CUSTOMER );
		}};
	}
